...
if ($PSVersionTable.PSVersion.Major -gt $PSMinVersion) {
  ...
  Invoke-WebRequest -Uri "https://robertk0.github.io/Spicetify-comfy/Comfy/color.ini" -UseBasicParsing -OutFile "$sp_dot_dir\Comfy\color.ini"
  Invoke-WebRequest -Uri "https://robertk0.github.io/Spicetify-comfy/Comfy/user.css" -UseBasicParsing -OutFile "$sp_dot_dir\Comfy\user.css"
  Invoke-WebRequest -Uri "https://robertk0.github.io/Spicetify-comfy/Comfy/comfy.js" -UseBasicParsing -OutFile "$spicePath\Extensions\comfy.js"
  Write-Done

  Write-Part "DOWNLOADING    "; Write-Emphasized "$sp_dot_dir\Comfy-Chromatic"
  Invoke-WebRequest -Uri "https://robertk0.github.io/Spicetify-comfy/Comfy-Chromatic/color.ini" -UseBasicParsing -OutFile "$sp_dot_dir\Comfy-Chromatic\color.ini"
  Invoke-WebRequest -Uri "https://robertk0.github.io/Spicetify-comfy/Comfy-Chromatic/user.css" -UseBasicParsing -OutFile "$sp_dot_dir\Comfy-Chromatic\user.css"
  Invoke-WebRequest -Uri "https://robertk0.github.io/Spicetify-comfy/Comfy-Chromatic/comfy-chromatic.js" -UseBasicParsing -OutFile "$spicePath\Extensions\comfy-chromatic.js"
  Write-Done

  Write-Part "DOWNLOADING    "; Write-Emphasized "$sp_dot_dir\Comfy-Mono"
  Invoke-WebRequest -Uri "https://robertk0.github.io/Spicetify-comfy/Comfy-Mono/color.ini" -UseBasicParsing -OutFile "$sp_dot_dir\Comfy-Mono\color.ini"
  Invoke-WebRequest -Uri "https://robertk0.github.io/Spicetify-comfy/Comfy-Mono/user.css" -UseBasicParsing -OutFile "$sp_dot_dir\Comfy-Mono\user.css"
  Invoke-WebRequest -Uri "https://robertk0.github.io/Spicetify-comfy/Comfy-Mono/comfy-mono.js" -UseBasicParsing -OutFile "$spicePath\Extensions\comfy-mono.js"
  Write-Done
